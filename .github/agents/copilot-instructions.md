...
- Kotlin 1.9.x with Compose Multiplatform 1.6+ + Compose Multiplatform, Kotlin Serialization, Jetpack Navigation Compose, Koin DI, Material Design 3 (add_explore_section)
- N/A (static navigation UI, no data persistence) (add_explore_section)
