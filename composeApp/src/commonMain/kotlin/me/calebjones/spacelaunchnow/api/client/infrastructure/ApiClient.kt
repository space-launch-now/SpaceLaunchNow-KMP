package me.calebjones.spacelaunchnow.api.client.infrastructure
...
import me.calebjones.spacelaunchnow.api.client.auth.ApiKeyAuth

import me.calebjones.spacelaunchnow.api.client.auth.*
...
open class ApiClient(
    ...
    private val authentications: kotlin.collections.Map<String, Authentication> by lazy {
        mapOf(
                "Token_Authentication" to ApiKeyAuth("header", "Authorization"),
                "cookieAuth" to ApiKeyAuth("query", "sessionid")
        )
    }

    companion object {
        const val BASE_URL: String = "https://ll.thespacedevs.com"
