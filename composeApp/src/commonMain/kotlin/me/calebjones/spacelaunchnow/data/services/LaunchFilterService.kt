...
class LaunchFilterService {
     ...
     * 
     * Note: Filters out "0" (Other/Unknown) to avoid wildcard behavior that exists
     * in notification filtering. For home screen filtering, we want explicit locations only.
     */
