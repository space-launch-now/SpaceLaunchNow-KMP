...
open class SpacecraftConfigurationsApi : ApiClient {
     ...
     * @return PaginatedSpacecraftConfigDetailedList
     */
    @Suppress("UNCHECKED_CAST")
    open suspend fun spacecraftConfigurationsDetailedList(agency: kotlin.Int? = null, humanRated: kotlin.Boolean? = null, inUse: kotlin.Boolean? = null, limit: kotlin.Int? = null, name: kotlin.String? = null, offset: kotlin.Int? = null, ordering: kotlin.String? = null, search: kotlin.String? = null): HttpResponse<PaginatedSpacecraftConfigDetailedList> {
        ...
        val localVariableConfig = RequestConfig<kotlin.Any?>(
            RequestMethod.GET,
            "/api/ll/2.4.0/spacecraft_configurations/detailed/",
     ...
     * @param ordering Which field to use when ordering the results. (optional)
     * @param search A search term. (optional)
     * @return PaginatedSpacecraftConfigNormalList
     */
    @Suppress("UNCHECKED_CAST")
    open suspend fun spacecraftConfigurationsList(agency: kotlin.Int? = null, humanRated: kotlin.Boolean? = null, inUse: kotlin.Boolean? = null, limit: kotlin.Int? = null, name: kotlin.String? = null, offset: kotlin.Int? = null, ordering: kotlin.String? = null, search: kotlin.String? = null): HttpResponse<PaginatedSpacecraftConfigNormalList> {
        ...
        val localVariableConfig = RequestConfig<kotlin.Any?>(
            RequestMethod.GET,
            "/api/ll/2.4.0/spacecraft_configurations/",
            query = localVariableQuery,
            headers = localVariableHeaders,
            requiresAuthentication = true,
        )
    ...
    open suspend fun spacecraftConfigurationsRetrieve(id: kotlin.Int): HttpResponse<SpacecraftConfigDetailed> {
        ...
        val localVariableConfig = RequestConfig<kotlin.Any?>(
            RequestMethod.GET,
            "/api/ll/2.4.0/spacecraft_configurations/{id}/".replace("{" + "id" + "}", "$id"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            requiresAuthentication = true,
        )
