...
class PaginatedUpdateEndpointListTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of PaginatedUpdateEndpointList
        //val modelInstance = PaginatedUpdateEndpointList()
