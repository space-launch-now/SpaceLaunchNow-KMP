...
# **dockingEventsList**
> PaginatedDockingEventEndpointNormalList dockingEventsList(docked, dockingDay, dockingGt, dockingGte, dockingLt, dockingLte, dockingMonth, dockingYear, dockingLocationId, flightVehicleChaserId, limit, offset, ordering, search, spaceStationTargetId)
...
val docked : kotlin.Boolean = true // kotlin.Boolean | 
...
try {
    val result : PaginatedDockingEventEndpointNormalList = apiInstance.dockingEventsList(docked, dockingDay, dockingGt, dockingGte, dockingLt, dockingLte, dockingMonth, dockingYear, dockingLocationId, flightVehicleChaserId, limit, offset, ordering, search, spaceStationTargetId)
    println(result)
...
### Parameters
| **docked** | **kotlin.Boolean**|  | [optional] |
