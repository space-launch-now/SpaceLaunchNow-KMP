...
> PaginatedExpeditionDetailedList expeditionsDetailedList(crewAstronaut, crewAstronautAgency, endGt, endGte, endLt, endLte, isActive, limit, name, offset, ordering, search, spaceStation, startGt, startGte, startLt, startLte)
...
# **expeditionsList**
> PaginatedExpeditionNormalList expeditionsList(crewAstronaut, crewAstronautAgency, endGt, endGte, endLt, endLte, isActive, limit, name, offset, ordering, search, spaceStation, startGt, startGte, startLt, startLte)
