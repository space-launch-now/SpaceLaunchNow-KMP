...
<a id="articlesRetrieve"></a>
# **articlesRetrieve**
> Article articlesRetrieve(id)
...
try {
    ...
    println("4xx response calling ArticlesApi#articlesRetrieve")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling ArticlesApi#articlesRetrieve")
    e.printStackTrace()
}
```
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **id** | **kotlin.Int**| A unique integer value identifying this article. | |
