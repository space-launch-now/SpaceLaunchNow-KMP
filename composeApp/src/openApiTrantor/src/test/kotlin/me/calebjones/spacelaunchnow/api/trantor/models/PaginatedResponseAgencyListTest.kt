...
class PaginatedResponseAgencyListTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of PaginatedResponseAgencyList
        //val modelInstance = PaginatedResponseAgencyList()
