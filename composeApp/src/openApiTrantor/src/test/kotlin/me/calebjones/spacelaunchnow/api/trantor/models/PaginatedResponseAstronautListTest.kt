...
class PaginatedResponseAstronautListTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of PaginatedResponseAstronautList
        //val modelInstance = PaginatedResponseAstronautList()
