...
class PaginatedResponseEventListTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of PaginatedResponseEventList
        //val modelInstance = PaginatedResponseEventList()
