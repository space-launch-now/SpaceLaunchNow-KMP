...
class PaginatedResponseFamilyListTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of PaginatedResponseFamilyList
        //val modelInstance = PaginatedResponseFamilyList()
