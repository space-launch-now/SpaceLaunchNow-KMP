...
class PaginatedResponseLaunchListTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of PaginatedResponseLaunchList
        //val modelInstance = PaginatedResponseLaunchList()
