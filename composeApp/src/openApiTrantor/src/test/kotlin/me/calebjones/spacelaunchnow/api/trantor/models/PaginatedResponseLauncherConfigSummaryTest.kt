...
class PaginatedResponseLauncherConfigSummaryTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of PaginatedResponseLauncherConfigSummary
        //val modelInstance = PaginatedResponseLauncherConfigSummary()
