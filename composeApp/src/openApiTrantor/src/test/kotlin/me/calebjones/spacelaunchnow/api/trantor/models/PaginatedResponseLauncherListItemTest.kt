...
class PaginatedResponseLauncherListItemTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of PaginatedResponseLauncherListItem
        //val modelInstance = PaginatedResponseLauncherListItem()
