...
class PaginatedResponseLocationListTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of PaginatedResponseLocationList
        //val modelInstance = PaginatedResponseLocationList()
