...
class PaginatedResponsePadSummaryTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of PaginatedResponsePadSummary
        //val modelInstance = PaginatedResponsePadSummary()
