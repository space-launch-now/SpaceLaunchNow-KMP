...
class PaginatedResponseProgramListTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of PaginatedResponseProgramList
        //val modelInstance = PaginatedResponseProgramList()
