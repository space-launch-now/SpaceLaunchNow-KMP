...
class PaginatedResponseSpacecraftConfigSummaryTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of PaginatedResponseSpacecraftConfigSummary
        //val modelInstance = PaginatedResponseSpacecraftConfigSummary()
