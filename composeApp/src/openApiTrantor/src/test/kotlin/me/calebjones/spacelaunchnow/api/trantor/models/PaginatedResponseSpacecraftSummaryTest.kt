...
class PaginatedResponseSpacecraftSummaryTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of PaginatedResponseSpacecraftSummary
        //val modelInstance = PaginatedResponseSpacecraftSummary()
