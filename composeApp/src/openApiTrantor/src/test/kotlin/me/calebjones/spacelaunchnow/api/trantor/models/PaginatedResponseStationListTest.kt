...
class PaginatedResponseStationListTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of PaginatedResponseStationList
        //val modelInstance = PaginatedResponseStationList()
