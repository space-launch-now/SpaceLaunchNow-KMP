...
class PaginatedResponseUpdateListTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of PaginatedResponseUpdateList
        //val modelInstance = PaginatedResponseUpdateList()
